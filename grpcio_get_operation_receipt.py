...
create_user_response: CreateUserResponse = users_stub.CreateUser(create_user_request)

open_debit_card_account_request = OpenDebitCardAccountRequest(
    user_id=create_user_response.user.id
)
open_debit_card_account_response: OpenDebitCardAccountResponse = accounts_stub.OpenDebitCardAccount(
...
make_top_up_operation_response: MakeTopUpOperationResponse = operations_stub.MakeTopUpOperation(
...
get_operation_receipt_response: GetOperationReceiptResponse = operations_stub.GetOperationReceipt(
