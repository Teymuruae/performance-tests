...
def build_gateway_grpc_client() -> Channel:
    ...
    return insecure_channel(f"{settings.gateway_grpc_client.host}:{settings.gateway_grpc_client.port}")
...
def build_gateway_locust_grpc_client(environment: Environment) -> Channel:
    ...
    channel = insecure_channel(f"{settings.gateway_grpc_client.host}:{settings.gateway_grpc_client.port}")
